...
def loess_2d(x1, y1, z, frac=0.5, degree=1, rescale=False,
    ...
    for j, (xj, yj) in enumerate(zip(x, y)):
        ...
        dist = np.sqrt((x - xj)**2 + (y - yj)**2)#calcultae distance between my point and all other points
        w = np.argsort(dist)[:npoints]#sort all distances and choose wanted ammount of points
